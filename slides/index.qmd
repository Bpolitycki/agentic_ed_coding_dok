...
::: {.setup-dataset}
**Gemeinsame Datengrundlage**<br>
*Digitale Edition der Tagebücher Andreas Okopenkos*<br>
TEI-Transkriptionen · Register · Stand-off-Kommentare · reda>ktionelle Texte · projektspezifisches Schema · IIIF-Faksimiles
:::
...
::: {.finding-row .finding-list-row}
::: {.finding-label}
Wissenschaftliche Funktionen
:::
::: {.finding-list}

- keine Zitierempfehlung
...
- Claude und OpenCode: referenzierbare Ansichten
- Codex: App-Logik ohne eigene URL-History
